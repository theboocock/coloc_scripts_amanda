...
source("/sc/orga/projects/psychgen/resources/COLOC2/claudia_scripts/coloc_scripts/scripts/functions_coloc_pipeline.R")
source("/sc/orga/projects/psychgen/resources/COLOC2/claudia_scripts/coloc_scripts/scripts/functions_coloc_likelihood_summary_integrated.R")
...
# eqtl.df = data.frame(fread(eqtl.fname, header=T))
 ...
 res1 = coloc.eqtl.biom(eqtl.df=eqtl.df, biom.df=biom.df, p12=p12, useBETA=useBETA, outfolder=outfolder, prefix=prefix, plot=plot, save.coloc.output=save.coloc.output, match_snpid=TRUE)
}
