...
res = coloc.eqtl.biom(eqtl.df=eqtl.df, biom.df=biom.df, p12=p12, useBETA=TRUE, outfolder=outfolder, prefix=prefix, plot=plot, save.coloc.output=TRUE, match_snpid=TRUE)
